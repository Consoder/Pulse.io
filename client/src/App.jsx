    ...
    const fetchAnalytics = async (shortCode) => {
        try {
            ...
            setSelectedLinkStats({
                ...
                realHumans: data.realHumans || 0,
                countries: transform(data.countries),
                os: transform(data.os),
                browsers: transform(data.browsers),
                referrers: transform(data.referrers),
                campaigns: transform(data.campaigns),
                timeline: timeline
            });
        } catch (err) {
                                                                ...
                                                                if (active && payload && payload.length) {
                                                                    return (
                                                                        <div className="bg-[#09090b]/90 backdrop-blur-md border border-white/10 p-3 rounded-lg shadow-xl flex items-center gap-3">
                                                                            ...
                                                                            <p className="text-white font-mono font-bold">{payload[0].name}</p>
